    ...
    public class TaxSlabController : Controller
    {
        ...
        public async Task<IActionResult> TaxSlabList(int id)
        {
            ...
            try
            {
                ...
                var taxSlabList = apiResponse.Result.OrderByDescending(p => p.Income_From).Select(p => new TaxSlabMasterDTO
                {
                ...
                int activeSlab = taxSlabList.Count(u => u.IsActive == true);
                int inactiveSlab = taxSlabList.Count(u => u.IsActive == false);
                ViewBag.ActiveSlab = activeSlab;
                ViewBag.InactiveSlab = inactiveSlab;
                ...
                return Json(new
                {
                    ...
                    activecount = activeSlab,
                    inactiveSlab = inactiveSlab,
                });
            }
            catch (SessionExpiredException ex)
            {
