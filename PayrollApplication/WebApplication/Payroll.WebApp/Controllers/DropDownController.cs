...
namespace Payroll.WebApp.Controllers
{
    public class DropDownController : Controller
    {
        ...
        public async Task<IActionResult> FetchCompaniesDropdown()
        {
            ...
            var viewModel = await _masterServiceHelper.BindCompaniesDataAsync(userId);
        ...
        {
            var dropdownItems = await _transactionServiceHelper.BindEnumDisplayNameToDropdownAsync<SalaryFrequencyEnum>();
            return Json(dropdownItems);
        }
        [HttpGet]
        ...
        [HttpGet]
        public async Task<IActionResult> FetchPaySlipNumberingScopeDropdown()
        {
            var dropdownItems = await _transactionServiceHelper.BindEnumListToDropdownAsync<PayslipNumberingScope>();
            return Json(dropdownItems);
        }
        [HttpGet]
        public async Task<IActionResult> FetchPayResetNumberingDropdown()
        {
            var dropdownItems = await _transactionServiceHelper.BindEnumListToDropdownAsync<PayslipResetNumbering>();
            return Json(dropdownItems);
        }
        [HttpGet]
        public async Task<IActionResult> FetchPaySlipIDFormatDropdown()
        {
            var dropdownItems = await _transactionServiceHelper.BindEnumListToDropdownAsync<PayslipIDFormat>();
            return Json(dropdownItems);
        }
        [HttpGet]
        ...
        [HttpGet]
        public async Task<IActionResult> FetchFinancialCycleDropdown()
        {
            var dropdownItems = await _transactionServiceHelper.BindEnumListToDropdownAsync<FinancialCycleType>();
            return Json(dropdownItems);
        }
        [HttpGet]
        ...
        [HttpGet]
        public async Task<IActionResult> FetchIsParentPaycomponentDropdown(int? EarnDedType,bool? IsChild)
        {
            int companyId = SessionCompanyId;
            var apiKey = await _userServiceHelper.GenerateApiKeyAsync();
            var dropdownItems = await _transactionServiceHelper.BindIsParentComponentAsync(apiKey, companyId, EarnDedType, IsChild);
        ...
        public async Task<IActionResult> FetchDistinctLocationDropdown(int companyId)
        {
            int userId = SessionUserId;
            var apiKey = await _userServiceHelper.GenerateApiKeyAsync();
            var dropdownItems = await _transactionServiceHelper.BindDistinctLocationAsync(apiKey, companyId, userId);
