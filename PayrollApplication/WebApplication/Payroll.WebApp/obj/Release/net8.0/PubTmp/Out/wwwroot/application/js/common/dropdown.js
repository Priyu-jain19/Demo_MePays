...
$(document).ready(function () {
    ...
    // Static dropdown configurations
    const dropdownConfigs = [
        { selector: '#usertype', url: '/DropDown/FetchUserTypeDropdown', placeholder: 'Select UserType', valueKey: 'value', textKey: 'text', autoSelectFirst: true },
        { selector: '#countries', url: '/DropDown/FetchCountriesDropdown', placeholder: '', valueKey: 'value', textKey: 'text', autoSelectFirst: true },
        { selector: '#salutationsDropdown', url: '/DropDown/FetchSalutationsDropdown', placeholder: 'Select Salutation', valueKey: 'value', textKey: 'text', autoSelectFirst: true },
        ...
        { selector: '#CorrespondanceType', url: '/DropDown/FetchCorrespondanceTypeDropdown', placeholder: 'Select Correspondance Type', valueKey: 'value', textKey: 'text', autoSelectFirst: true },
        { selector: '#CorrespondanceType2', url: '/DropDown/FetchCorrespondanceTypeDropdown', placeholder: 'Select Correspondance Type', valueKey: 'value', textKey: 'text', autoSelectFirst: true },
    ...
    $('#Companies').change(function () {
        ...
        if (companyId) {
            const response = fetchSync('/DropDown/GetCompanyLocationData', { companyId });
