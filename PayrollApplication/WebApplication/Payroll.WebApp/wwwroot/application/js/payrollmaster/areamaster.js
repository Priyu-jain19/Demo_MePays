...
$(document).ready(function () {
    ...
    $(document).on('change', '#EditCountryDropdown', function () {
        ...
        clearDropdown('#EditStateDropdown', 'Select State');
        clearDropdown('#EditCityDropdown', 'Select City');
        clearDropdown('#EditLocationDropdown', 'Select Location');
...
function validateAreaForm(formType) {
    ...
    var formPrefix1 = formPrefix == 'edit' ? 'Edit' : formPrefix
    var locationValue = $('#' + formPrefix1 + 'LocationDropdown').val();
    if (locationValue == '' || locationValue === null || locationValue === undefined) {
...
$(document).ready(function () {
    ...
    $(document).off('click', '#confirmAreaDelete').on('click', '#confirmAreaDelete', function () {
