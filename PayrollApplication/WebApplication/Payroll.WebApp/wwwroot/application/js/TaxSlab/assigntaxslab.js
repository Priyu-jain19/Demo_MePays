$(document).ready(function () {
    ...
    //////////////////////////////////// OPEN FILTER TAB On button click (18-08-25):- START  //////////////////////////////
    ...
    /////////////////////////////////// OPEN FILTER TAB On button click (18-08-25):- End/////////////////////////////////
    $('#standardFilterModal').modal('show').on('shown.bs.modal', function () {
    ...
    $(document).on("click", '#applyFilterBtn', function () {
        ...
        const filterData = {
            ...
            SelectFilter: "",
            Regime_Id: $('#taxregimeDropdown').val() || 0,
    ...
    data.forEach((item, index) => {
        tbody += `
            <tr>
                ...
                <td>${item.previous_Regime ?? ''}</td> 
                <td>${item.present_Regime ?? ''}</td> 
            </tr>
        `;
    });
