            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.isSuccess && response.result) {
                        ...
                        // ✅ Populate City Dropdown - Filter by selected state
                        if (data.cities && data.cities.length > 0) {
                            let cityDropdown = $("#branch");
                            cityDropdown.empty();
                            cityDropdown.append(`<option value="">Select City</option>`);

                            // Get the selected state ID to filter cities
                        ...
                        $("#state").off('change.cityFilter').on('change.cityFilter', function () {
                            ...
                            $("#department").val(null).trigger("change"); // Clear locations too
                        });

                        // ✅ City Change Event - Filter Locations
                        $("#branch").off('change.locationFilter').on('change.locationFilter', function () {
