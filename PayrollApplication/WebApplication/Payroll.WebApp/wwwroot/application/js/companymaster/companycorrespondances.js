...
function validateCompanyAddress() {
    ...
    if (/^\s|\s$/.test(rawCompanyAddress)) {
        $("#CompanyAddress-error").text("Please provide valid company address.");
        return false;
    }
...
function validateBuildingNo() {
    ...
    if (/^\s|\s$/.test(rawBuildingNo)) {
        $("#Building-No-error").text("Please provide valid building no.");
        return false;
    }
...
function validateBuildingName() {
    ...
    if (/^\s|\s$/.test(rawBuildingName)) {
        $("#Building-Name-error").text("Please provide valid building name.");
        return false;
    }
...
function validateStreet() {
    ...
    // Check for leading or trailing whitespace in raw input
    if (/^\s|\s$/.test(rawStreet)) {
        $("#Street-error").text("Please provide valid street.");
        return false;
    }
