...
namespace Payroll.WebApp.Helpers
{
    public class RestApiMasterServiceHelper
    {
        ...
        public async Task<CompanyViewModel> BindCompaniesDataAsync(int userId)
        {
            CompanyViewModel obj = new CompanyViewModel();
            string companyApiUrl = $"{_apiSettings.PayrollMasterServiceEndpoints.GetAllCompanyMasterDetailUrl}?user_Id={userId}";
