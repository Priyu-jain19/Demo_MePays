...
builder.Services.Configure<RestrictedUrlSettings>(
    builder.Configuration.GetSection("RestrictedUrlSettings"));
...
app.UseSession();
app.UseMiddleware<SingleTabRestrictionMiddleware>();
